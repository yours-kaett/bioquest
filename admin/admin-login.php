	...
	<div id="start">
		...
		<div class="starting-table-main">
			...
			<div class="starting-table-grids">
				<form action="admin-login-check.php" method="post" class="start_form slideanim">
					<div class="form">
						<div class="col-lg-6 col-md-6 col-sm-12 grid_6 c1">
							<img src="../images/logo.png" alt="NONESCOST LOGO">
							<input type="text" name="admin_id" placeholder="Admin ID" class="fs-4" required>
						...
						<div class="col-lg-6 col-md-6 col-sm-12 grid_6 c1">
							<div class="starter-block agile">
								...
								<div class="starter-gd-bottom">
									<div class="starter-list fs-1 p-4">
										<h6 class="bed"><i class="fa fa-user-secret" aria-hidden="true"></i></h6>
									</div>
								</div>
							</div>
						</div>
