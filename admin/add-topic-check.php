        ...
        if (file_exists($targetFile)) {
            ...
            if ($_FILES["fileToUpload"]["size"] > 100000000) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    $stmt = $conn->prepare("INSERT INTO tbl_topics (topic_title, filename, filepath, created_at) VALUES (?, ?, ?, ?)");
                    $stmt->bind_param('ssss', $topic_title, $filename, $upload_path, $created_at);
                    $stmt->execute();
