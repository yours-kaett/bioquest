...
if (isset($_SESSION['id'])) {
    ...
    $blank = "";
    $stmt = $conn->prepare(' SELECT * FROM tbl_quiz_student WHERE room_number = ? AND student_id = ? AND student_answer <> ? ');
    $stmt->bind_param('iis', $room_number, $student_id, $blank);
    $stmt->execute();
    $result = $stmt->get_result();
    if (mysqli_num_rows($result) > 0) {
        header("Location: room-number.php");
        exit;
    }
?>
    <!DOCTYPE html>
                                                        ...
                                                        <fieldset class="row mb-4 mt-3">
                                                            <div class="col-lg-6">
                                                                <div class="form-check mb-2">
                                                                    ...
                                                                    <label class="form-check-label border-0 fw-bold p-2 fs-2 w-100 text-center" for="choice1_' . $item_number . '">
                                                                        ' . $choices[0] . '
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="form-check mb-2">
                                                                    ...
                                                                    <label class="form-check-label border-0 fw-bold p-2 fs-2 w-100 text-center" for="choice2_' . $item_number . '">
                                                                        ' . $choices[1] . '
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="form-check mb-2">
                                                                    ...
                                                                    <label class="form-check-label border-0 fw-bold p-2 fs-2 w-100 text-center" for="choice3_' . $item_number . '">
                                                                        ' . $choices[2] . '
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="form-check mb-2">
                                                                    ...
                                                                    <label class="form-check-label border-0 fw-bold p-2 fs-2 w-100 text-center" for="choice4_' . $item_number . '">
                                                                        ' . $choices[3] . '
                                                                    </label>
                                                                </div>
                                                            </div>
            ...
            function showQuestion(index) {
                if (index < questions.length) {
                    ...
                    var timer = setInterval(function() {
                        ...
                        document.getElementById("timer").innerText = "00:" + (10 - timerCount).toString().padStart(2, "0");
                        timerCount++;
                        if (timerCount > 10) {
                            clearInterval(timer);
                            timerCount = 1;
