                                                        ...
                                                        <fieldset class="row mb-4 mt-3">
                                                            <div class="col-lg-6">
                                                                <div class="form-check mb-2">
                                                                    ...
                                                                    <label class="form-check-label border-0 fw-bold p-3 fs-1 w-100 text-center" for="choice1_' . $item_number . '">
                                                                        ' . $choices[0] . '
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="form-check mb-2">
                                                                    ...
                                                                    <label class="form-check-label border-0 fw-bold p-3 fs-1 w-100 text-center" for="choice2_' . $item_number . '">
                                                                        ' . $choices[1] . '
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="form-check mb-2">
                                                                    ...
                                                                    <label class="form-check-label border-0 fw-bold p-3 fs-1 w-100 text-center" for="choice3_' . $item_number . '">
                                                                        ' . $choices[2] . '
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="form-check mb-2">
                                                                    ...
                                                                    <label class="form-check-label border-0 fw-bold p-3 fs-1 w-100 text-center" for="choice4_' . $item_number . '">
                                                                        ' . $choices[3] . '
                                                                    </label>
                                                                </div>
                                                            </div>
