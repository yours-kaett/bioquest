                    ...
                    <div class="pagetitle">
                        ...
                        <nav style="--bs-breadcrumb-divider: '•';">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">pH Scale</li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 d-flex flex-column align-items-center justify-content-center">
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            <iframe width="1110" height="740" src="https://phet.colorado.edu/sims/html/ph-scale/latest/ph-scale_all.html" frameborder="0" class="mt-3 position-relative" style="z-index: 1;"></iframe>
