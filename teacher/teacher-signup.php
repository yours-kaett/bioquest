	...
	<div id="start">
		...
		<div class="starting-table-main">
			...
			<div class="starting-table-grids">
				<form action="teacher-signup-check.php" method="post" class="start_form slideanim">
					<div class="form">
						<div class="col-lg-6 col-md-6 col-sm-12 grid_6 c1">
							...
							<input type="password" name="auth_code" placeholder="Authentication Code" class="fs-4" required>
							...
							if (isset($_GET['invalid'])) {
								?>
									<p class="d-flex align-items-center justify-content-between bg-warning text-dark rounded-5 fs-3 p-3 mt-5">
										<span></span>
										<?php echo $_GET['invalid'], "Invalid authentication code."; ?>
							...
							?>
								<p class="d-flex align-items-center justify-content-between bg-warning text-dark rounded-5 fs-3 p-3 mt-5">
									<span></span>
									<?php echo $_GET['registered'], "Username already registered."; ?>
									<a href="teacher-signup.php">
										<button type="button" class="btn-close text-white fs-5" data-bs-dismiss="alert" aria-label="Close"></button>
									</a>
								</p>
						...
						<div class="col-lg-6 col-md-6 col-sm-12 grid_6 c1">
							<div class="starter-block agile mt-5 pt-5">
								...
								<div class="starter-gd-bottom">
									...
									<div class="starter-selet">
										<a class="fs-4" href="teacher-login.php">
